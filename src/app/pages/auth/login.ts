    ...
    template: `
        ...
        <div class="bg-[var(--bg-dark)] dark:bg-[var(--bg-dark)] flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 20px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-dark) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-[var(--bg-dark)] dark:bg-[var(--bg-dark)] py-20 px-8 sm:px-20" style="border-radius: 20px">
                        <div class="text-center mb-8">
                            <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-8 w-16 shrink-0 mx-auto">
                                ...
                                <mask id="mask0_1413_1551" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8" width="54" height="11">
                                    <path d="M27 18.3652C10.5114 19.1944 0 8.88892 0 8.88892C0 8.88892 16.5176 14.5866 27 14.5866C37.4824 14.5866 54 8.88892 54 8.88892C54 8.88892 43.4886 17.5361 27 18.3652Z" fill="var(--primary-dark)" />
                                </mask>
                            ...
                            <div class="text-[var(--text-dark)] dark:text-[var(--text-dark)] text-3xl font-medium mb-4">Login to Template!</div>
                            <span class=" text-[var(--text-dark)] dark:text-[var(--text-dark)] font-medium">Sign in to continue</span>
                        </div>
                        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="login mb-8">
                            <label for="email1" class="block text-[var(--text-dark)] dark:text-[var(--text-dark)] text-xl font-medium mb-2">Email</label>
                            <input pInputText id="email1" formControlName="email" type="text" placeholder="Email address" class="w-full md:w-[30rem] mb-8" />

                            <label for="password1" class="block text-[var(--text-dark)] dark:text-[var(--text-dark)] font-medium text-xl mb-2">Password</label>
                            ...
                            <div class="flex items-center justify-between text-[var(--text-dark)] dark:text-[var(--text-dark)] mt-2 mb-8 gap-8">
                                <div class="flex items-center">
                                    <p-checkbox formControlName="rememberMe" id="rememberme1" binary class="mr-2"></p-checkbox>
                                    <label for="rememberme1">Remember me</label>
                                </div>
                                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-[var(--primary-dark)]">Forgot password?</span>
                            </div>
                            <button type="submit" class="py-2.5 px-4 bg-[var(--primary-dark)] dark:bg-[var(--primary-dark)] text-center w-full rounded-full duration-150 flex items-center justify-center gap-x-1 h-12 text-[var(--text-light)] bg-[var(--primary)] hover:bg-[var(--primary-shadow)] ring-offset-2 ring-blue-600 focus:ring shadow rounded-lg active:bg-gray-900">
                                Login
                            </button>                        
                        </form>

                        <div class="text-center text-[var(--text-dark)] dark:text-[var(--text-dark)] mb-8">
                            Don't have an account? <a [routerLink]="'/register'"><strong class=" text-[var(--primary-dark)] dark:text-[var(--primary-dark)]">  Register here </strong></a>
                        </div>
