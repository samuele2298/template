    ...
    template: ` 
        ...
        <div class="bg-[var(--bg-dark)] dark:bg-[var(--bg-dark)] flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 20px; padding: 0.3rem; background: linear-gradient(180deg, rgba(247, 149, 48, 0.4) 10%, rgba(247, 149, 48, 0) 30%)">
                    <div class="w-full bg-[var(--bg-dark)] dark:bg-[var(--bg-dark)] py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 20px">
                        <div class="gap-4 flex flex-col items-center">
                            ...
                            <h1 class="text-[var(--text-dark)] dark:text-[var(--text-dark)] font-bold text-4xl lg:text-5xl mb-2">Access Denied</h1>
                            <span class="text-[var(--text-dark)] dark:text-[var(--text-dark)] mb-8">You do not have the necessary permisions. Please contact admins.</span>
                            <img src="https://primefaces.org/cdn/templates/sakai/auth/asset-access.svg" 
                                alt="Access denied" 
                                class="text-[var(--text-dark)] dark:text-[var(--text-dark)] mb-8" 
                                width="80%" />
