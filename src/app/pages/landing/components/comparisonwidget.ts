...
@Component({
    ...
    template: `
        <div id="comparison" class="text-[var(--text-light)] body-font overflow-hidden">
            <div class="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
                <div class="mx-auto max-w-2xl lg:max-w-4xl">
                <h2 class="text-lg font-semibold leading-8 text-[var(--primary)] dark:text-[var(--primary)]">Comparison</h2>
                <p class="mt-2 text-4xl font-bold tracking-tight text-[var(--text-light)] dark:text-[var(--text-light)]">Comparison..</p>
                </div>
            </div>
            <div class="container px-20 mx-5 py-24 mx-auto flex flex-wrap">
                <div class="lg:w-1/4 mt-48 hidden lg:block">
                    ...
                    <div class="lg:w-1/3 lg:mt-px w-full mb-10 lg:mb-0 border-2 border-[var(--border)] lg:border-none rounded-lg lg:rounded-none">
                        ...
                        <p class="bg-[var(--background)] text-[var(--text-light)] h-12 text-center px-2 flex items-center -mt-px justify-center border-t border-[var(--border)]">Schlitz single-origin</p>
