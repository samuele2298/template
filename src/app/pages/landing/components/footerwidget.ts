        ...
        <footer class="bg-[var(--background)] dark:bg-[var(--background)] px-8 lg:px-8">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-8 lg:py-10">
                ...
                <a class="flex items-center sm: mb-10" href="#">
                    ...
                    <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">Template</span>
                </a>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400 ">© 2025 <a href="/" class="hover:underline">Template</a>. All Rights Reserved.
                </span>
