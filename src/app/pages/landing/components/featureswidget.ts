...
@Component({
    ...
    <!-- <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
        <div class="relative mb-10  mx-auto max-w-7xl px-6 text-center lg:px-8">
            <div class="mx-auto max-w-2xl lg:max-w-4xl">
                ...
                <p class="mt-2 text-4xl font-bold tracking-tight text-[var(--text-light)] dark:text-[var(--text-dark)] dark:text-[var(--text-light)] dark:text-[var(--text-dark)]">Features..</p>
            </div>
        </div>
         ...
         <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
            ...
            >
                <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                    <div class="text-[var(--text-light)] dark:text-[var(--text-dark)] mb-2 text-3xl font-semibold">Joséphine Miller</div>
                    <span class="text-[var(--text-light)] dark:text-[var(--text-dark)] text-2xl">Peak Interactive</span>
                    <p class="text-[var(--text-light)] dark:text-[var(--text-dark)] sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
    ...
    <div class="py-12 bg-[var(--bg-light)] dark:bg-[var(--bg-dark)] text-[var(--text-light)] dark:text-[var(--text-dark)] dark:text-[var(--text-dark)] sm:py-12 lg:py-16">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative mx-auto max-w-7xl px-6 text-center lg:px-8 mb-10">
                <div class="mx-auto max-w-2xl lg:max-w-4xl">
                <h2 class="text-lg font-semibold leading-8 text-[var(--primary-light)] dark:text-[var(--primary-dark)]">Features</h2>
                <p class="mt-2 text-4xl font-bold tracking-tight text-[var(--text-light)] dark:text-[var(--text-dark)] dark:text-[var(--text-dark)]">Features..</p>
                </div>
            </div>
            <div class="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
                <div class="relative shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)]">
                    <div class="absolute -inset-1">
                        <div
                            class="w-full h-full rotate-180 opacity-30 blur-lg filter ">
                        </div> 
                    </div>
                    <div class="relative overflow-hidden bg-[var(--bg-light)] dark:bg-[var(--bg-dark)]  rounded-xl h-full">
                        <div class="p-9"><svg class="w-12 h-12 mx-auto text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mx-0" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11 8L20 8"  class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]" stroke-width="2" stroke-linecap="round"></path>
                                <path d="M4 16L14 16" class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]" stroke-width="2" stroke-linecap="round"></path>
                                <ellipse cx="7" cy="8" rx="3" ry="3" transform="rotate(90 7 8)" class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]"
                                    stroke-width="2" stroke-linecap="round"></ellipse>
                                <ellipse cx="17" cy="16" rx="3" ry="3" transform="rotate(90 17 16)" class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]"
                                    stroke-width="2" stroke-linecap="round"></ellipse>
                            </svg>
                            <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">Realtime Collaboration</h3>
                            <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Collaborate in realtime with other editors in a
                                project. See what othe editors are doing and edit even a simple text together</p>
                        </div>
                    </div>
                </div>
                
                <div class="overflow-hidden shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)] rounded-xl">
                    <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="13" y="14" width="2" height="2" rx="1" class="fill-[var(--primary-light)] dark:fill-[var(--primary-dark)]" ></rect>
                            <rect x="7" y="11" width="2" height="6" rx="1" class="fill-[var(--primary-light)] dark:fill-[var(--primary-dark)]" ></rect>
                            <rect x="11" y="13" width="2" height="6" rx="1" transform="rotate(90 11 13)" class="fill-[var(--primary-light)] dark:fill-[var(--primary-dark)]" >
                            </rect>
                            <rect x="16" y="12" width="2" height="2" rx="1" class="fill-[var(--primary-light)] dark:fill-[var(--primary-dark)]" ></rect>
                            <path
                                ...
                                class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]"  stroke-width="2" stroke-linecap="round"></path>
                            <path
                                ...
                                class="stroke-[var(--primary-light)] dark:stroke-[var(--primary-dark)]"  stroke-width="2"></path>
                        </svg>
                        <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">History of Edits</h3>
                        <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Go back and forth your history of changes and
                ...
                <div class="relative shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)]">
                    ...
                    <div class="relative overflow-hidden shadow-md rounded-xl h-full">
                        <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            ...
                            <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">Integrations</h3>
                            <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Step up your designs and workflow with
                ...
                <div class="overflow-hidden shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)] rounded-xl">
                    <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                        ...
                        <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">Publish webpage online</h3>
                        <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Effortlessly publish your webpages online and make
                ...
                <div class="relative shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)]">
                    ...
                    <div class="relative overflow-hidden shadow-md rounded-xl h-full">
                        <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            ...
                            <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">Forms and Data Collection
                            </h3>
                            <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Collect data and information from users with
                ...
                <div class="overflow-hidden shadow-lg shadow-[var(--primary-light-shadow)] dark:shadow-[var(--primary-dark-shadow)] rounded-xl">
                    <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                        ...
                        <h3 class="mt-6 text-2xl font-bold text-[var(--text-light)] dark:text-[var(--text-dark)] sm:mt-10">Custom Domains</h3>
                        <p class="mt-6 text-base text-[var(--text-light)] dark:text-[var(--text-dark)]">Attach your own custom domain to your published
